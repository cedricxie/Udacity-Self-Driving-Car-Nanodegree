...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
  ...
  ****************************************************************************/
  if (!is_initialized_) {
    ...
    x_ << px, py, 0, 0, 0;
    cout << "Initiation Completed, x_: " << endl;
    cout << x_ << endl;
  ...
  Prediction(dt);
  cout << "Predict Completed, x_: " << endl;
  cout << x_ << endl;
  ...
  if (meas_package.sensor_type_ == MeasurementPackage::RADAR) {
    cout << "Update Started for Radar" << endl;
    UpdateRadar(meas_package);
    cout << "Update Completed, NIS for Radar: " << endl;
    cout << NIS_radar_ << endl;
  }
  else if (meas_package.sensor_type_ == MeasurementPackage::LASER) {
    cout << "Update Started for Laser" << endl;
    UpdateLidar(meas_package);
    cout << "Update Completed, NIS for Laser: " << endl;
...
void UKF::Prediction(double delta_t) {
  ...
  */
  ...
  x_aug_(5) = 0;
  x_aug_(6) = 0;
  cout << "Prediction: x_aug_: " << endl;
  cout << x_aug_ << endl;
  P_aug_.fill(0.0);
  P_aug_.topLeftCorner(n_x_,n_x_) = P_;
  P_aug_(5,5) = std_a_*std_a_;
  P_aug_(6,6) = std_yawdd_*std_yawdd_;
  cout << "Prediction: P_aug_: " << endl;
  cout << P_aug_<< endl;
  MatrixXd L = P_aug_.llt().matrixL();
  //cout << "Prediction: Generate Sigma Points, L" << endl;
  ...
  //cout << "Prediction: Xsig_aug_: " << endl;
  //cout << Xsig_aug_<< endl;
  ...
  cout << "Prediction: Calculate Mean and Covariance" << endl;
  x_.fill(0.0);
